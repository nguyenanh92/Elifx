...
namespace PCar.Areas.Administrator.Controllers
{
    ...
    //            {
    //                List<GalleryDto> list = db.Galleries.OrderBy(a => a.Index).Select(a => new GalleryDto()
    //                {
    //                    ID = a.ID,
    //                    Title = a.Title,
    //                    Image = a.LargeImage,
    ...
    //    [HttpPost]
    //    [ValidateInput(false)]
    //    public JsonResult Create(GalleryDto model)
    //    {
    //        using (var db = new MyDbDataContext())
    //        {
    ...
    //    [HttpPost]
    //    [ValidateInput(false)]
    //    public JsonResult Edit(GalleryDto model)
    //    {
    //        using (var db = new MyDbDataContext())
    //        {
    //            if (ModelState.IsValid)
