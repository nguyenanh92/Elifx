...
{
    public abstract class ElifxWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ElifxWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ElifxWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ElifxDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ElifxDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ElifxDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ElifxDbContext, Task<T>> func)
        {
            T result;
